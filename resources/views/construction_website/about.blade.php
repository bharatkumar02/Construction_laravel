  ...
  <section class="bg-gray-100 lg:py-24 flex flex-col-reverse *:lg:w-1/2 lg:flex-row">
    <div class="lg:text-start px-6 md:px-10 lg:px-10 xl:px-16 py-10 lg:pt-0 pb-16">
      ...
      <p class="mt-4 text-[15px] leading-relaxed tracking-wide">
        From a small local fleet to a trusted construction rental partner, BuildStrong Rentals has been powering projects across the region for over a decade.
      </p>

      <div class="mt-6 space-y-5 text-[15px] leading-relaxed tracking-wide">
        <p>
          Founded in <span class="font-semibold text-gray-900">2010</span>, we began with a simple goal — to make construction vehicle rentals more reliable, transparent, and accessible.
        </p>
        <p>
          By <span class="font-semibold text-gray-900">2015</span>,we had expanded our fleet and introduced specialized machinery for large-scale industrial and infrastructure projects.
        </p>
        <p>
          Today, with over
          <span class="font-semibold text-gray-900">1500+ successful clients</span> and
          a growing team of professionals, we continue to deliver efficient rental solutions backed by integrity, punctuality, and performance.
        </p>
      </div>
      <!-- Founder Quote -->
      <blockquote
  ...
  <section class="px-6 pt-16 bg-white lg:px-14 xl:px-32 pb-28">
    <div class="text-center lg:pb-10">
      ...
      <h2 class="mt-2 text-3xl font-bold font-montserrat">
        Meet the People Behind the Wheels </h2>
      <p class="mt-3 text-gray-600 max-w-2xl mx-auto leading-relaxed">
        Our dedicated professionals ensure every rental runs smoothly — from fleet maintenance to timely delivery and on-site support.
      </p>
    </div>
