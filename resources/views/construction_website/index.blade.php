...
<section class="flex flex-col-reverse gap-0 items-center lg:flex-row lg:h-full">
  ...
  <div class="p-8 lg:pl-20 xl:pl-28">
    <div class="flex items-start justify-between pb-5">
      <div>
        <h6 class="text-yellow-600 font-montserrat font-semibold">
          Power That Moves Your Project
        </h6>
        <h1 class="mt-4 text-4xl lg:text-5xl font-bold leading-tight font-montserrat">
          Looking for the <span class="text-yellow-600">best construction vehicles?</span>
        </h1>
        <p class="my-4 text-gray-700 text-[15px]">
          Rent heavy-duty machines from trusted providers — ready when and where you need them. </p>
      </div>
    </div>
    <div class="hover:-translate-y-1 transition-all duration-300 w-fit">
      <a href="#contact" class="px-6 py-3 bg-black  text-white font-montserrat">
        Contact Us
  ...
  <div class="relative w-full lg:z-20 lg:pt-16">
    ...
    <div
      class="absolute h-[70%] bg-gradient-to-b from-black via-black to-black/85 w-full top-0 -z-10 lg:h-full lg:w-[65%] lg:right-0"></div>
  </div>
</section>
...
<section class="px-6 pt-16 bg-gray-50 lg:px-10 xl:px-32 pb-28">
  ...
  <div class="mt-8 text-center mx-auto hover:-translate-y-1 transition-all duration-300 w-fit">
    <a href="{{route('equipment')}}" class="mt-4 px-6 py-2.5 bg-black text-white font-montserrat">
      View More
      <span class="font-medium text-lg pl-1.5"><i class="ri-arrow-right-long-fill"></i></span>
    </a>
  </div>
...
<section class="max-w-7xl mx-auto -mt-14 md:text-center lg:text-start">
  <div
    ...
    <div class="flex items-center gap-2 font-montserrat text-sm">
      <a href="#contact" class="px-5 py-3 bg-yellow-500 font-semibold">Get A Quote</a>
    ...
    <div
      class="hidden lg:block absolute right-0 top-0 -z-10 lg:bg-yellow-500 lg:h-full lg:w-[12rem]"></div>
  </div>
</section>
...
<section
  ...
  <div class="text-center lg:text-start px-6 md:px-10 lg:px-16">
    <div class="text-sm text-yellow-600 font-semibold">Our Work Process</div>
    ...
    <ul
      ...
      <li>
        <strong
          class="size-[2.4rem] border-2 border-yellow-500 text-yellow-600 grid place-items-center text-lg">1</strong>
        <span class="w-5 bg-yellow-500 h-0.5 mr-2"></span>
        <h3 class="font-semibold">Request Your Vehicle</h3>
      </li>
      <li>
        <strong
          class="size-[2.4rem] border-2 border-yellow-500 text-yellow-600 grid place-items-center text-lg">2</strong>
        <span class="w-5 bg-yellow-500 h-0.5 mr-2"></span>
        <h3 class="font-semibold">Get a Quick Quote</h3>
      </li>
      <li>
        <strong
          class="size-[2.4rem] border-2 border-yellow-500 text-yellow-600 grid place-items-center text-lg">3</strong>
        <span class="w-5 bg-yellow-500 h-0.5 mr-2"></span>
        <h3 class="font-semibold">Confirm Your Booking</h3>
      </li>
      <li>
        <strong
          class="size-[2.4rem] border-2 border-yellow-500 text-yellow-600 grid place-items-center text-lg">4</strong>
        <span class="w-5 bg-yellow-500 h-0.5 mr-2"></span>
        <h3 class="font-semibold">Receive On-Site Delivery</h3>
      </li>
      <li>
        <strong
          class="size-[2.4rem] border-2 border-yellow-500 text-yellow-600 grid place-items-center text-lg">5</strong>
        <span class="w-5 bg-yellow-500 h-0.5 mr-2"></span>
        <h3 class="font-semibold">Use with Full Support</h3>
      </li>
      <li>
        <strong
          class="size-[2.4rem] border-2 border-yellow-500 text-yellow-600 grid place-items-center text-lg">6</strong>
        <span class="w-5 bg-yellow-500 h-0.5 mr-2"></span>
        <h3 class="font-semibold">Return Hassle-Free</h3>
      </li>
    </ul>
    <div class="mt-8 text-center hover:-translate-y-1 transition-all duration-300 w-fit">
      <a href="{{route('about')}}" class="mt-4 px-6 py-2.5 bg-black text-white font-montserrat">
        Know More
        <span class="font-medium text-lg pl-1.5"><i class="ri-arrow-right-long-fill"></i></span>
      </a>
    </div>
  ...
  <div class="lg:rounded-l-md relative z-10 mt-5 lg:mt-0">
    ...
    <div
      class="hidden lg:block absolute h-full w-full bg-black -left-10 top-10 -z-10 rounded-l-md"></div>
  </div>
</section>
  ...
  <div class="px-6 md:px-16 lg:py-4">
    <div class="text-center lg:pb-10 lg:text-start">
      ...
      <ul
        ...
        <li>
          <span
            class="size-[2.4rem] border-2 border-yellow-500 text-yellow-600 grid place-items-center text-lg"><i class="ri-team-fill"></i></span>
          <span class="w-5 bg-yellow-500 h-0.5 mr-2"></span>
          <h3 class="font-semibold">Expert Support</h3>
        </li>
        <li>
          <span
            class="size-[2.4rem] border-2 border-yellow-500 text-yellow-600 grid place-items-center text-lg"><i class="ri-tools-fill"></i></span>
          <span class="w-5 bg-yellow-500 h-0.5 mr-2"></span>
          <h3 class="font-semibold">Reliable Fleet</h3>
        </li>
        <li>
          <span
            class="size-[2.4rem] border-2 border-yellow-500 text-yellow-600 grid place-items-center text-lg">
    ...
    <div class="mt-8 text-center lg:mt-0 lg:text-start hover:-translate-y-1 transition-all duration-300">
      <a href="#contact" class="px-6 py-2.5 bg-yellow-500 text-white font-semibold">
        Contact Us
        <span class="font-medium text-lg pl-1.5"><i class="ri-arrow-right-long-fill"></i></span>
      </a>
    </div>
    ...
    <div class="absolute w-full -bottom-10">
      <div
        ...
        <ul class="flex items-center gap-5 *:flex *:flex-col tracking-wide md:gap-16">
          <li>
            <span class="text-xl font-montserrat font-bold lg:text-2xl xl:text-3xl">1.5k</span><span class="text-xs md:text-sm">Clients Served</span>
          </li>
          <li>
            <span class="text-xl font-montserrat font-bold lg:text-2xl xl:text-3xl">15+</span><span class="text-xs md:text-sm">Years of Experience</span>
          </li>
          <li>
            <span class="text-xl font-montserrat font-bold lg:text-2xl xl:text-3xl">40+</span><span class="text-xs md:text-sm">Vehicles Available</span>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="swiper-wrapper pt-0 pb-20">
      ...
      <div class="swiper-slide bg-white p-5 shadow-md">
        ...
        <div class="font-semibold font-montserrat flex gap-3 flex items-center">
          <div class="max-w-[3rem] p-1.5 border-dashed border">
            <img src="https://printo-s3.dietpixels.net/site/T-shirts/App_1753334972.png?quality=70&format=webp&w=640" alt="" class="w-full" />
          </div>
          <h4 class="flex">
            John Deo <span class="w-5 mt-5 h-0.5 bg-black"></span>
          </h4>
        </div>
      </div>
      <div class="swiper-slide bg-white p-5 shadow-md">
      ...
      <div class="swiper-slide bg-white p-5 shadow-md">
        ...
        <div class="font-semibold font-montserrat flex gap-3 flex items-center">
          ...
          <h4 class="flex">
            Preeti Sharma <span class="w-5 mt-5 h-0.5 bg-black"></span>
          </h4>
        </div>
      </div>
      <div class="swiper-slide bg-white p-5 shadow-md">
        ...
        <div class="font-semibold font-montserrat flex gap-3 flex items-center">
          ...
          <h4 class="flex">
            Sahil <span class="w-5 mt-5 h-0.5 bg-black"></span>
          </h4>
        </div>
      </div>
      <div class="swiper-slide bg-white p-5 shadow-md">
